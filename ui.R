    ...
    mainPanel(
      tabsetPanel(type = "tabs", 
                  ...
                  tabPanel("Sagebrush",
                           ...
                           h5("Explore how fast big sagebrush can recover using an equation for logistic population growth, and interactive sliders on the left. For example, drag the «Year» slider to the right to see what big sagebrush cover may look like in 2050! Feel free to also change «r» and «K» parameters (we will explore the rest of sliders in a minute). How do r and K change the curve of recovery?"),
                  ...
                  tabPanel("Map", h4("Boise foothills in early Spring"),
                           img(src='drawing3.png', width = 800),
                           ...
                           plotOutput("landscapePlot", width = 800, height = 300)
                           ) 
                  )
